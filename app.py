...
model = {
    'voting_classifier': pickle.load(open('./trained_voting_classifier.pkl', 'rb')),
    'catboost_classifier': pickle.load(open('./trained_catboost_classifier.pkl', 'rb'))
}
...
def upload():
    ...
    if file:
        ...
        catboost_classifier = model['catboost_classifier']
        classifications = catboost_classifier.predict(features_df)
